...
$('document').ready(function () {
  /* This Listens for changes on each amenities INPUT checkbox tag */
  const amenitiesId = {};
  ...
  /* This Listens for changes on each states INPUT checkbox tag */
  const statesId = {};
  const citiesId = {};
  const citiesStates = {};
  ...
  /* This Listens for changes on each cities INPUT checkbox tag */
  ...
  */
  ...
  /* This Retrieves all places and creates an articule tag with them */
  ...
  /*
    This Gets reviews list from a place when display class is clicked
  */
  ...
  /* This Filters all places by amenities on button search click */
