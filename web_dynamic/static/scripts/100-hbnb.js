...
$('document').ready(function () {
  /* This Listens to changes on each amenities INPUT checkbox tag */
  const amenitiesId = {};
  ...
  /* This Gets status of api and change class if api not available
  ...
  */
  ...
  callout();
  /*
    This Retrieves all places and create a articule tag with them
  */
